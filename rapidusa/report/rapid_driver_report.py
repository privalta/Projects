...
class ReportRapidDriver(models.AbstractModel):
    ...
    def _get_report_values(self, docsids, data=None):
        ...
        transfers = self.env["rapidusa.rapid_driver"].search([("cr_date", ">=", start_date), ("cr_date", "<=", end_date)])
        ...
        for i in transfers:
            ...
            j = {"route_id": i.route_id.route_name, "date": date, "cantidad": i.cars_total, "unit_price": format(i.route_id.fee, ".2f"), "amount": i.fees_related, "cars": i.rapidcar_ids}
