...
class TestPayrollAccount(common.TransactionCase):
    def setUp(self):
        ...
        self.hr_salary_rule_houserentallowance1 = self.ref("payroll.hr_salary_rule_houserentallowance1")
    ...
    def _update_account_in_rule(self, debit, credit):
        rule_houserentallowance1 = self.env["hr.salary.rule"].browse(self.hr_salary_rule_houserentallowance1)
        rule_houserentallowance1.write({"account_debit": debit, "account_credit": credit})
    ...
    def test_00_hr_payslip(self):
        ...
        res = self.hr_payslip.get_payslip_vals(date_from, date_to, self.hr_employee_john.id)
        vals = {
