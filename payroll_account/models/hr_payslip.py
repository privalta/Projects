    ...
    def action_payslip_done(self):
        ...
        for slip in self:
                ...
                if debit_account_id:
                    debit_line = (
                        ...
                        0,
                        {
                            ...
                            "analytic_account_id": analytic_salary_id or slip.contract_id.analytic_account_id.id,
            ...
            if len(line_ids) > 0:
                ...
                logger.warning(f"Payslip {slip.number} did not generate any account move lines")
        return res
