...
class Payslips(BrowsableObject):
    ...
    def sum(self, code, from_date, to_date=None):
        _logger.warning("Payslips Object: sum() method is DEPRECATED. Use sum_rule() instead.")
    ...
    def sum_category(self, code, from_date, to_date=None):
        ...
        hierarchy_codes = self.env["hr.salary.rule.category"].search([("code", "=", code)]).children_ids.mapped("code")
