...
class TestBrowsableObject(TestPayslipBase):
    ...
    def test_init(self):
        ...
        self.assertEqual(obj.env, self.env, "Env is retrieved successfully from nested dictionary")
        self.assertEqual(obj.level1.employee_id, 0.0, "Employee Id is *NOT* in BaseBrowsableObject")
        self.assertEqual(
            obj.level1.env,
            900.0,
